...
- Move Invite Team menu state and platform-neutral rendering into shared Compose while keeping SMS intents, QR bitmap generation, and NFC operations in Android adapters.
