...
- iOS key-value persistence is implemented in `iosMain` with `NSUserDefaultsPreferencesStore` and `NSUserDefaultsReferralStorage`, keeping Apple framework types outside shared contracts and product policy.
