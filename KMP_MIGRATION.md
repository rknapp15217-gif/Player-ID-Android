...
- Game schedule reads now pass through a shared profile/repository contract backed by an Android Room adapter. TeamViewModel preserves its existing entity API while the storage boundary becomes implementable by an iOS host.
