...
- Move the roster page header, search, count, empty state, and add/import commands to shared Compose while keeping photo picking and URI persistence in Android wrappers.
